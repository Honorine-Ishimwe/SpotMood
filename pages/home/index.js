...
export default function Home() {
    ...
    useEffect(() => {
        ...
        async function getOnRepeatPlaylistId() {
            ...
            while (nextURL) {
                ...
                const maxIndex = Math.min(playlists.length - 1, 9);
    ...
    }, [isSpotifyUser, playlistId, session?.token?.access_token]);
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full md:w-4/10 lg:w-4/10 p-2">
                        {isSpotifyUser ? (
                            ...
                            <p className="text-white text-center text-xl">Connect Spotify to see your playlist here!</p>
                        )}
                    </div>
                </div>
            </main>
